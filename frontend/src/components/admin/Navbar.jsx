      ...
      <>
        ...
        <nav className="relative px-4 py-4 flex justify-between items-center bg-white">
          ...
          <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:items-center lg:w-auto lg:space-x-6">
            <li>
              <Link to={'addspaces'} className="text-sm text-gray-400 hover:text-gray-500" href="#">
                Add Spaces
              </Link>
            </li>
            ...
            <li>
              <Link to={'managespaces'} className="text-sm text-gray-400 hover:text-gray-500" href="#">
                Manage Spaces
              </Link>
            </li>
            <li className="text-gray-300">
            ...
            <li>
              <Link to={'manageusers'} className="text-sm text-gray-400 hover:text-gray-500" href="#">
                Manage User
              </Link>
            </li>
